# MGS-Poptracker-Pack
Poptracker pack for Masala Garden Salad v1.0 by TheRealSolidusSnake

Features all locations in the game and logic for the easy yaml difficulty currently.
All bosses are also currently needing to be manually toggled so ensure you toggle them after you defeat them - hopefully fixed for next release, along with hard logic and auto selection.
